...
class HistoryBoard(Frame):
    def __init__(self, master,**kargs):
        ...
        historyTableDatas.setColumns('time', 'value', 'maxValue','AValue','CValue')
        # column
        ...
        concentration1HistoryTableDatas.setColumns('time', 'value', 'maxValue','AValue','CValue')
        # column
        ...
        concentration1HistoryTableDatas.column("value",anchor=CENTER, width=110)
        ...
        concentration1HistoryTableDatas.heading("value",text="基值",anchor=CENTER)
        concentration1HistoryTableDatas.heading("maxValue",text="峰值",anchor=W)
        ...
        concentration2HistoryTableDatas.setColumns('time', 'value', 'maxValue','AValue','CValue')
        # column
        ...
        concentration2HistoryTableDatas.column("value",anchor=CENTER, width=110)
        ...
        concentration2HistoryTableDatas.heading("value",text="基值",anchor=CENTER)
        concentration2HistoryTableDatas.heading("maxValue",text="峰值",anchor=W)
        ...
        concentration3HistoryTableDatas.setColumns('time', 'value', 'maxValue','AValue','CValue')
        # column
        ...
        concentration3HistoryTableDatas.column("value",anchor=CENTER, width=110)
        ...
        concentration3HistoryTableDatas.heading("value",text="基值",anchor=CENTER)
        concentration3HistoryTableDatas.heading("maxValue",text="峰值",anchor=W)
    ...
    def refreshPage(self):
        ...
        ## concentration1History
        ##
        self.concentration1HistoryTreeTable.delete(*self.concentration1HistoryTreeTable.get_children())
        concentration1HistoryTableDatas = self.concentration1HistoryTableDatas
        ...
        ## concentration2History
        ##
        self.concentration2HistoryTreeTable.delete(*self.concentration2HistoryTreeTable.get_children())
        concentration2HistoryTableDatas = self.concentration2HistoryTableDatas
        ...
        ## concentration3History
        ##
        self.concentration3HistoryTreeTable.delete(*self.concentration3HistoryTreeTable.get_children())
        concentration3HistoryTableDatas = self.concentration3HistoryTableDatas
