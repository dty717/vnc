...
def checkBuffer(recBuffer, requestBuffer):
    if len(recBuffer) < 4:
        ...
        return False
    if recBuffer[0] != requestBuffer[0]:
        # print("address error")
        return False
    if recBuffer[1] != requestBuffer[1]:
        # print("command error")
        return False
    if recBuffer[1] == 0x03:
...
# datas = [0xba,0x99,0x41,0x81,0x20,0x88,0xc0,0x5F,0x06,0x00,0x00,0x18,0x20,0x00,0x00,0x00,0x20,0x07,0x00,0x00,0x95,0x00,0x00,0x00,0x30,0x00,0x00,0x00,0x15,0x03,0x00,0x00,0x14,0x00,0x00,0x00,0x30,0x00,0x00,0x00,0x65,0x00,0x00,0x00,0x05,0x00,0x00,0x00,0x01,0x00,0x00,0x00,0x00,0x00,0x30,0x00,0x06,0x08,0x17,0x29,0x12]
